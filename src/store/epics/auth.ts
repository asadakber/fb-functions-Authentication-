...
import {LOGIN, LOGIN_SUCCESS, LOGOUT, LOGOUT_SUCCESS ,SIGNUP, SIGNUP_SUCCESS, SIGNUP_FAILED, LOGIN_FAILED } from '../actions/auth';
    ...
    signup = (actions$: ActionsObservable<any>) => {
        ...
        .switchMap(({payload, navCtrl}) => {
            ...
            .switchMap((responce) => {
                ...
                let url = "https://us-central1-mapbox-cb4cc.cloudfunctions.net/signup"
    ...
    login = (actions$: ActionsObservable<any>) => {
        ...
        .switchMap(({payload, navCtrl}) => {
            ...
            .switchMap((responce) => {
                ...
                let url = "https://us-central1-mapbox-cb4cc.cloudfunctions.net/login"
                return this.http.post(url, payload, {headers: headers})
                .switchMap(res => {
                    navCtrl();
